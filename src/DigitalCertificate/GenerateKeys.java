...
public class GenerateKeys {
	...
	public GenerateKeys(int keylength) throws NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException,
			IOException, IOException, CertificateException, SignatureException, SignatureException {
